...
![\Small x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}](https://latex.codecogs.com/svg.latex?\Small&space;x=\frac{-b\pm\sqrt{b^2-4ac}}{2a}) 
![\Small I(s_{i}) = log(1/p(s_{i})) = -log p(s_{i})](https://latex.codecogs.com/eqneditor/editor.php)